# Getting started with Databricks Lakebase and Node.js (postgres.js)

This example shows how to connect to Databricks Lakebase from Node.js using the [postgres.js](https://www.npmjs.com/package/postgres) library. It includes scripts for basic CRUD (Create, Read, Update, Delete) operations.

## Clone the repository

```bash
npx degit databricks-solutions/lakebase-examples/with-node-postgres-js ./with-node-postgres-js
